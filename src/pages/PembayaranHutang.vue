      ...
      <div class="row">
        <div class="col-12 d-flex justify-content-between">
          ...
          <div>
            ...
            <button type="button" class="float-right" v-on:click="backToHutang">
...
export default {
  ...
  data() {
    return {
      ...
      tipeCode: 0,
      idKartuKontak: "",
      idAkunKeuangan: this.$settings.akunPembayaranHutangKredit.id,
      idAkunKeuanganDebit: this.$settings.akunPembayaranHutangDebit.id,
      deskripsi: "",
      jumlah: "",
      paging: [],
      pageno: 0,
      ...
      dataSize: 500,
      isAccMode: false,
      idHutang: this.$route.query.idHutang,
    };
  },
  methods: {
    showProgress() {
    ...
    simpanData() {
      if (
        ...
        if (this.saveTipe == 0) {
          this.$axios
            .post(this.$url + "hutang/pembayaran/adddata/" + this.$idOutlet, JSON.stringify(postdata), {
              headers: {
          ...
          this.$axios
            .put(this.$url + "hutang/pembayaran/updatedata/" + this.id, JSON.stringify(postdata), {
              headers: {
                "Content-Type": "application/json",
              },
            })
    ...
    editData(id, tanggal, idAkunKeuangan,idAkunKeuanganDebit, deskripsi, jumlah) {
      this.id = id;
    ...
    deleteData() {
      this.showProgress();
      this.$axios.delete(this.$url + "hutang/pembayaran/deletedata/" + this.id).then((response) => {
        this.closeProgress();
