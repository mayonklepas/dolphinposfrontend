<template>
  <div class="Transaksi Pembelian">
      ...
      <div class="row" style="margin-bottom: 5px">
        <div class="col-12 d-flex justify-content-between">
          ...
          <div>
            ...
            <button type="button" class="float-right" v-on:click="backToPembelian">
    ...
    <div class="row">
      <div class="col-2">
        <label>Tanggal</label>
        <input type="date" v-model="tanggalPembelian" />
      </div>
      <div class="col-2">
        <label>No. Invoice</label>
        <div>
          <input type="text" v-model="kodePembelianMaster" style="width:78% ;" />
          <button style="width:20%;" v-on:click="generateInvCode"><i class="fa fa-qrcode"></i></button>
        </div>
      </div>
      <div class="col-2">
        <label>Supplier / Personal</label>
      ...
      <div class="col-2">
        ...
        <label v-if="isAccMode == false">Diambil Dari</label>
        <br />
          ...
          <table class="table-minimal">
            <thead>
              <tr>
                ...
                <th class="pointer">Satuan</th>
                <th class="pointer">Tipe</th>
            ...
            <tbody>
              <tr v-for="(x, index) in resData" :key="index">
                ...
                <td style="width: 100px" v-show="false">
                ...
                <td style="width: 60px">
                  <input type="number" v-model.number="x.jumlahBeli" v-on:keyup="calculatetotalrow(index)"
                    v-on:click="calculatetotalrow(index)" />
                </td>
    ...
    <div class="row">
      ...
      <div class="col-6">
        <div class="row">
          <div class="col-8">
            <span class="float-right tx-bold">Total Pembelian : </span>
          </div>
          <div class="col-4">
            <span class="float-right tx-bold">{{
                totalPembelian | formatNumber
            }}</span>
          </div>
          <div class="col-8">
...
export default {
  ...
  data() {
    return {
      ...
      idAkunKeuangan: this.$settings.akunPembelianKredit.id,
      idAkunKeuanganDebit: this.$settings.akunPembelianDebit.id,
      deskripsi: "",
  ...
  methods: {
      ...
      if (this.tipe == 0) {
        ...
        this.$axios
          ...
          .then((response) => {
            ...
            this.kodePembelianMaster = data.kodePembelianMaster;
            ...
            this.tax = data.tax;
            this.disc = data.disc;
            this.resData = data.pembelianDetail;
    ...
    saveData() {
      ...
      if (
        ...
        if (this.resData.length > 0) {
          ...
          let postdatamaster = {
            kodePembelianMaster: this.kodePembelianMaster,
          ...
          for (let i = 0; i < this.resData.length; i++) {
            postdatadetail.push({
              idPembelianMaster: idMaster,
              tanggalTransaksi: this.tanggalPembelian,
              ...
              jumlahBeli: this.resData[i].jumlahBeli,
          ...
          this.$axios
            .post(this.$url + "pembelian/" + dest, JSON.stringify(postdata), {
              headers: {
        ...
        this.$axios
          ...
          .then((response) => {
            ...
            if (response.data !== null) {
              ...
              this.resData[index].jumlahBeli = 1;
    ...
    calculatetotalrow(index) {
      ...
      let jumlah = this.stdNum(this.resData[index].jumlahBeli);
    ...
    calculatetotalall() {
      let totalpembelianraw = 0;
      for (let i = 0; i < this.resData.length; i++) {
        totalpembelianraw = totalpembelianraw + this.resData[i].total;
      }
      this.totalPembelian = totalpembelianraw;
    },
    calculategrandtotal() {
      let persentax =
        (this.tax / 100) *
        (parseFloat(this.stdNum(this.totalPembelian)) - this.disc);
      let totalplusdisc =
        parseFloat(this.stdNum(this.totalPembelian)) - this.disc;
    ...
    pilihModalBarang(
      ...
      this.resData[this.indexPosition].jumlahBeli = 1;
    ...
    generateInvCode() {
      ...
      this.$axios
        ...
        .then((response) => {
          this.kodePembelianMaster = response.data.content
          console.log(response);
          this.closeProgress();
        });
    }
